...
const [checked, setChecked] = useState(false)
   const handleClicke = (e) => {
    ...
    return (
        <>
        <label className={`${styles.hamburger} ${open === true ? 'translate-x-[200px] fixed -translate-y-[60px]  transition-transform duration-500 delay-200' : 'duration-500'}`} onClick={(e) => handleClicke(e)}>
